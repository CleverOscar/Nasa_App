...
export default function Images(props) {
    ...
    const images = <div className="h-auto border-2 border-black my-10" key={props.data.id}>
        <img className="w-full h-auto  border-8 border-inherit border-double rounded-lg shadow-2xl mx-auto" src={props.data.img_src} alt={props.data.camera.name} />
        <p className='text-xl text-center'>{props.data.camera.full_name} </p>
